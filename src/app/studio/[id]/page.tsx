                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex flex-col justify-between h-full">
                            <div className="flex flex-col h-full">
                                ...
                                <textarea value={textToSpeach} onChange={(e) => handleChangeTextToSpeech(e.target.value)} className="flex p-4 px-8 font-thin text-xs h-full min-h-40 outline-none" placeholder="Start typing here or paste any scripts you want to generate into a voiceover." required />
                            </div>
